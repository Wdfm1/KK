...
<div id="content">
    ...
    <asp:GridView ID="gv1" runat="server" Height="16px" Width="648px" 
        ...
        DataKeyNames="DetailId" AllowPaging="True" PageSize="16" >
...
<asp:TemplateField HeaderText="Options">
            ...
            <Columns>
                ...
                <ItemStyle HorizontalAlign="Center" Font-Italic="True" Font-Size="8pt" />
...
<table style="width:700px;">
        ...
        <tr>
            ...
            <asp:DropDownList ID="ddlshipmeth1" runat="server" 
                    ...
                    AppendDataBoundItems="True" AutoPostBack="True" 
                                    >
                                                                <asp:ListItem Value="STANDARD">Standard - 10 Business Days</asp:ListItem>
                                                                <asp:ListItem Value="EXPRESS">Expedited - 2-10 Business Days</asp:ListItem>
        ...
        <tr>
            ...
            <td class="style46">
              ...
              <asp:TextBox ID="txtzip" runat="server" AutoPostBack="True" MaxLength="5" 
