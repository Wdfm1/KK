      ...
      <a href="#"onclick="MM_swapImage('theImg5','','../images/package/whitecombo.jpg',1)">
        <img src="../images/package/caps_gowns/kk_regalia_white.jpg" width="25" height="50" alt="kk_regalia_white.jpg" id="173" onclick="changevalue3(this);" /></a>
 								 ...
 								 <tr>
    								...
    								<td width="85" class="floatleft"><asp:DropDownList  runat="server" Height="20px" onchange="change(this);" DataSourceID="dscapclr" DataTextField="optiondesc" DataValueField="id" ID="ddlclr" CausesValidation="True"></asp:DropDownList>
<script>
     function change(x) {
         ...
         i.src = img[x.selectedIndex];
								...
								<tr>
									<td align="right">
        								<asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                                            ...
                                            ForeColor="Red" ValidationExpression="^\d+$"></asp:RegularExpressionValidator> <asp:TextBox ID="txtqty0" runat="server" Width="36px" CausesValidation="True"></asp:TextBox>
                                    </td>
									<td class="floatleft">
								...
								<tr>
        							<td colspan="2">
                          				<script>     var img1 = ["../images/tasselandsashes/tassel.jpg", "../images/tasselsandsashes/tassels/0002.jpg", "../images/tasselsandsashes/tassels/00011.jpg", "../images/tasselsandsashes/tassels/0008.jpg", "../images/tasselsandsashes/tassels/0009.jpg", "../images/tasselsandsashes/tassels/00010.jpg", "../images/tasselsandsashes/tassels/0003.jpg", "../images/tasselsandsashes/tassels/0001.jpg", "../images/tasselsandsashes/tassels/0000.jpg", "../images/tasselsandsashes/tassels/0005.jpg", "../images/tasselsandsashes/tassels/0006.jpg", "../images/tasselsandsashes/tassels/0004.jpg", "../images/tasselsandsashes/tassels/0007.jpg", "../images/tasselsandsashes/tassels/00012.jpg"];
                                        </script>
        <a href="#" onclick="MM_swapImage('theImg5','','../images/tasselsandsashes/tassels/0002.jpg',1)">
                        <img src="../images/tasselsandsashes/tassels/tassel_small_NEW/Tassel_rainbow_13_SM.jpg" alt="" width="25" height="60" border="0" id="180" onclick="changevalue2(this);" /></a>
                        
                        <a href="#" onclick="MM_swapImage('theImg5','','../images/tasselsandsashes/tassels/00011.jpg',1)">
                        <img src="../images/tasselsandsashes/tassels/tassel_small_NEW/Tassel_purple_13_SM.jpg" alt="" id="189" onclick="changevalue2(this);" border="0" /></a>
