<%@ Page Title="" Language="VB"  AutoEventWireup="false" CodeFile="achieverpkgcart.aspx.vb" Inherits="achieverpkgcart" %>
...
<table align="left" cellpadding="0" cellspacing="0" style="width: 673px; height: auto; margin-right: 0px;">
	<tr>
		<td width="271" height="30" valign="top" class="style13">
			<a href="../shopjostenshome.aspx">Home</a> &gt; <a href="../packages.aspx">Packages</a><br /><strong><span class="style15">Achiever Package<br /><br /></span></strong>
        </td>
		<td></td>
	</tr>
	<tr>
		<td class="style25" valign="top"><img src="../images/package/achieverpackage_2.jpg" alt="Achiever Package" name="theImg5"  id="theImg5" onmouseover="MM_swapImgRestore()" />&nbsp;&nbsp;<asp:Label ID="lblprodcode" runat="server" ForeColor="Black" Text="03KACHPKD" Visible="False"></asp:Label>
        </td>
		<td valign="top" rowspan="2">
			<div  id="packprice"> 
				<strong>Our Price: <span class="red">$</span><asp:Label ID="LBLPK" runat="server" ForeColor="#D74141" Text="03KACHPKD"></asp:Label></strong><br /><br /><font color="#0000CC"><em>Note:</em> Cap and Gown in packages will be the same color.</font><br /><br />
        ...
        <img src="../images/package/caps_gowns/kk_gown_black.jpg" width="25" height="50" 
                        alt="kk_regalia_white.jpg" id="247" onclick="changevalue3(this);" /></a>
      ...
      <a href="#"onclick="MM_swapImage('theImg5','','../images/package/whitecombo.jpg',1)">
        <img src="../images/package/caps_gowns/kk_regalia_white.jpg" width="25" height="50" alt="kk_regalia_white.jpg" id="173" onclick="changevalue3(this);" /></a>
              							...
              							<tr>
                							<td width="290">Cap/Gown Color*: 
                                            </td>
                							<td width="90" class="floatleft"><asp:DropDownList  runat="server" Height="22px" 
                                                    Width="116px" onchange="change3(this);" datasourceid="dscapclr" 
                      ...
                      function change3(x) {
                          ...
                          i.src = img3[x.selectedIndex];
              							...
              							<tr>
                							<td>Gown <a href="http://www.jostenskinderkraft.com/size_chart.html" target="_blank">Size</a>/Height*:<br /><font size="-3"><em>Enter QTY of each size needed</em></font>
                                            </td>
     										<td class="floatleft"><a href="javascript:;" onclick="MM_popupMsg('Measure from the top of the child\'s head to the floor.')"><img src="../images/capsandgowns/measure_quest.png" alt="" width="15" height="15" border="0" /></a>
                                            </td>
                                       	</tr>
    									<tr>
											<td align="right"><asp:RegularExpressionValidator ID="numval" runat="server" ControlToValidate="txtqty6" ErrorMessage="Enter a numeric value" ForeColor="Red" ValidationExpression="^\d+$" Display="Dynamic"></asp:RegularExpressionValidator> <asp:TextBox ID="txtqty6" runat="server" Width="36px" CausesValidation="True" AutoPostBack="True">1</asp:TextBox>
                                            </td>
											<td class="floatleft"><asp:DropDownList ID="ddlsize" runat="server" Height="20px" Width="116px" DataSourceID="dsgwnsize" DataTextField="optiondesc" DataValueField="id" CausesValidation="True"></asp:DropDownList><br />
                                            </td>
                                        </tr>
										<tr>
											<td class="style36" align="right" valign="top"><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtqty5" ErrorMessage="Enter a numeric value" ForeColor="Red" ValidationExpression="^\d+$" Display="Dynamic"></asp:RegularExpressionValidator> <asp:TextBox ID="txtqty5" runat="server" Width="36px" CausesValidation="True" AutoPostBack="True"></asp:TextBox>
                                            </td>
											<td class="style36" valign="top"><asp:DropDownList ID="ddlsize0" runat="server" Height="20px" Width="116px" DataSourceID="dsgwnsize" DataTextField="optiondesc" DataValueField="id" CausesValidation="True"></asp:DropDownList>
                                            </td>
                                      	</tr>
										<tr>
											<td align="right" valign="top"><asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtqty4" ErrorMessage="Enter a numeric value" ForeColor="Red" ValidationExpression="^\d+$" Display="Dynamic"></asp:RegularExpressionValidator> <asp:TextBox ID="txtqty4" runat="server" Width="36px" CausesValidation="True" AutoPostBack="True"></asp:TextBox>
                                            </td>
											<td class="floatleft"><asp:DropDownList ID="ddlsize1" runat="server" Height="20px" Width="116px" DataSourceID="dsgwnsize" DataTextField="optiondesc" DataValueField="id" CausesValidation="True"></asp:DropDownList><span class="style32"></span>
                                            </td>
                                     	</tr>
										<tr>
											<td align="right" valign="top"><asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtqty3" ErrorMessage="Enter a numeric value" ForeColor="Red" ValidationExpression="^\d+$" Display="Dynamic"></asp:RegularExpressionValidator> <asp:TextBox ID="txtqty3" runat="server" Width="36px" CausesValidation="True" AutoPostBack="True"></asp:TextBox>
                                            </td>
											<td class="floatleft"><asp:DropDownList ID="ddlsize2" runat="server" Height="20px" Width="116px" DataSourceID="dsgwnsize" DataTextField="optiondesc" DataValueField="id" CausesValidation="True"></asp:DropDownList>
                                            </td>
                                       	</tr>
										<tr>
											<td align="right" valign="top"><asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtqty2" ErrorMessage="Enter a numeric value" ForeColor="Red" ValidationExpression="^\d+$" Display="Dynamic"></asp:RegularExpressionValidator> <asp:TextBox ID="txtqty2" runat="server" Width="36px" CausesValidation="True" AutoPostBack="True"></asp:TextBox>
                                            </td>
											<td class="floatleft"><asp:DropDownList ID="ddlsize3" runat="server" Height="20px" Width="116px" DataSourceID="dsgwnsize" DataTextField="optiondesc" DataValueField="id" CausesValidation="True"></asp:DropDownList>
                                            </td>
                                      	</tr>
										<tr>
											<td align="right" valign="top"><asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="txtqty2" ErrorMessage="Enter a numeric value" ForeColor="Red" ValidationExpression="^\d+$" Display="Dynamic"></asp:RegularExpressionValidator> 
                                                <asp:TextBox ID="txtqty1" runat="server" Width="36px" CausesValidation="True" 
                                                    AutoPostBack="True"></asp:TextBox>
                                            </td>
											<td class="floatleft"><asp:DropDownList ID="ddlsize4" runat="server" Height="20px" 
                                                    Width="116px" ataSourceID="dsgwnsize" DataTextField="optiondesc" 
                                                    DataValueField="id" CausesValidation="True" DataSourceID="dsgwnsize"></asp:DropDownList>
                                            </td>
                                      	</tr>
										<tr>
											<td align="right" valign="top">
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                                                    ...
                                                    ForeColor="Red" ValidationExpression="^\d+$" Display="Dynamic"></asp:RegularExpressionValidator> <asp:TextBox ID="txtqty0" runat="server" Width="36px" CausesValidation="True"></asp:TextBox>
                                            </td>
											<td class="floatleft"><asp:DropDownList ID="ddlsize5" runat="server" Height="20px" Width="116px" DataSourceID="dsgwnsize" DataTextField="optiondesc" DataValueField="id" CausesValidation="True"></asp:DropDownList>
        									</td>
                                     	</tr>
										<tr>
                							<td colspan="2">
                         ...
                         <a href="#" onclick="MM_swapImage('theImg5','','../images/tasselsandsashes/tassels/0002.jpg',1)">
                        <img src="../images/tasselsandsashes/tassels/tassel_small_NEW/Tassel_rainbow_13_SM.jpg" alt="" width="25" height="60" border="0" id="180" onclick="changevalue(this);" /></a>
                        
                        <a href="#" onclick="MM_swapImage('theImg5','','../images/tasselsandsashes/tassels/00011.jpg',1)">
                        <img src="../images/tasselsandsashes/tassels/tassel_small_NEW/Tassel_purple_13_SM.jpg" alt="" id="189" onclick="changevalue(this);" border="0" /></a>
                        ...
                        <img src="../images/tasselsandsashes/tassels/tassel_small_NEW/Tassel_white_13_SM.jpg" alt=""  id="245" onclick="changevalue(this);" border="0" /></a>
              							...
              							<tr>
                							<td height="30" class="style37">Tassel Color*
                                            </td>
                							<td class="floatleft"><asp:DropDownList  runat="server" Height="21px" Width="140px" onchange="change2(this);" ID="ddltasclr" datasourceid="dscolor" DataTextField="optiondesc" DataValueField="id"> </asp:DropDownList>
                <script>
                      function change2(x) {
                          var i = document.getElementById("theImg5");
      ...
      <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/noahs_arc_kindergarten.jpg" width="37" height="27" alt="noahs_arc_kindergarten.jpg" id="202" onclick="changevalue1(this);" /></a>
      
      <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/BrightBeginnings_PreK_Swap.jpg',1)">
      <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/noahs_arc_preschool.jpg" width="37" height="27" alt="noahs_arc_preschool.jpg" id="201" onclick="changevalue1(this);"/></a>                         
                                  
      <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/Chalkboard_Elem_Swap.jpg',1)" >
        <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/chalkboard_elementary.jpg" alt="chalkboard_elem.jpg" width="37" height="27" id="200" onclick="changevalue1(this);" /></a>
      
      <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/Chalkboard_Kinder_Swap.jpg',1)">
        <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/chalkboard_kindergarten.jpg" alt="chalkboard_kindergarten" width="37" height="27" id="199" onclick="changevalue1(this);" /></a>
      
      <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/Chalkboard_PreK_Swap.jpg',1)">
        <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/chalkboard_preschool.jpg" width="37" height="27" alt="chalkboard_preschool"  id="198" onclick="changevalue1(this);"/></a>
       
        <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/dog.jpg',1)">
      <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/learn_grow_elementary.jpg" width="37" height="27" alt="learn_grow_elementary.jpg" id="205" onclick="changevalue1(this);" /></a>
      
      <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/cog.jpg',1)">
      <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/learn_grow_general.jpg" width="37" height="27" alt="learn_grow_general.jpg"id="206" onclick="changevalue1(this);" /></a>
       <br />
      <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/LearningBlocks_Elem_Swap.jpg',1)">
        <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/learning_blocks_elem.jpg" width="37" height="27" alt="learning_blocks_elem.jpg" id="204" onclick="changevalue1(this);" /></a>
      
      <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/LearningBlocks_Kinder_Swap.jpg',1)">
        <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/learning_blocks_kindergarten.jpg" width="37" height="27" alt="learning_blocks_kindergarten.jpg" id="203" onclick="changevalue1(this);" /></a>
        
        <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/LearningBlocks_PreK_Swap.jpg',1)">
        <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/learning_blocks_prek.jpg" width="37" height="27" alt="learning_blocks_prek.jpg" id="100" onclick="changevalue1(this);" /></a>
            
      <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/SmartStarts_Elem_Swap.jpg',1)">
      <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/SmartStarts_Elem.jpg" width="37" height="29" alt="SmartStarts_Elem" id="101" onclick="changevalue1(this);"/></a>
      
      <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/SmartStarts_Kinder_Swap.jpg',1)">
      <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/SmartStarts_Kinder.jpg" width="37" height="29" alt="SmartStarts_Kinder" id="102" onclick="changevalue1(this);"/></a>
      
      <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/SmartStarts_PreK_Swap.jpg',1)">
      <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/SmartStarts_PreK.jpg" width="37" height="29" alt="SmartStarts_PreK" id="103" onclick="changevalue1(this);"/></a>
      
       <a href="#" onclick="MM_swapImage('theImg5','','../images/diplomasandcertificates/diplomas/SmartStarts_General_Swap.jpg',1)">
       <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/SmartStarts_General.jpg" width="37" height="29" alt="SmartStarts_General" id="104" onclick="changevalue1(this);"/></a>
       										</td>
  										</tr>
  										<tr>
    										<td>Diploma/Certificate*
                                            </td>
    										<td class="floatleft"><asp:DropDownList  runat="server" Height="25px" Width="196px" onchange="change(this);" ID="ddlcert" datasourceid="dscertificate" DataTextField="optiondesc" DataValueField="id"> </asp:DropDownList>
    												<script>
          												function change(x) {
              												var i = document.getElementById("theImg5");
  										...
  										<tr>
    										<td colspan="2">Pkg Qty: <asp:TextBox ID="txtqty" runat="server" Width="36px" causesvalidation="True">1</asp:TextBox> &nbsp;&nbsp;&nbsp; <asp:Button ID="Button1" runat="server" Text="Add to Cart " ValidationGroup="g1"/><br /><span class="pkg_order_instr">Place orders for one gown/cap color at a time.</span><br />

      								<div class="req_field_val">
                                    	<asp:CustomValidator ID="CustomValidator5" runat="server" ErrorMessage="Qty field 1 must be 1 or greater."></asp:CustomValidator><br /><asp:CustomValidator ID="CustomValidator4" runat="server" ControlToValidate="ddlclr" Display="Dynamic" ErrorMessage="Please select a color" ValidationGroup="g1"></asp:CustomValidator>
                                    </div>
                                    		</td>
  										</tr> 
									</table> 
