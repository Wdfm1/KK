...
Partial Class milestonepkgcart
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Page.IsValid Then
            ...
            arroptions(0, 1) = Me.ddlcapclr.SelectedValue
            arroptions(0, 2) = Me.ddlcapclr.SelectedItem.Text
            arroptions(0, 3) = "04KMILEPKD"
            arroptions(0, 4) = 45

            arroptions(1, 1) = Me.ddltasclr.SelectedValue
            arroptions(1, 2) = Me.ddltasclr.SelectedItem.Text
            arroptions(1, 3) = "04KMILEPKD"
            arroptions(1, 4) = 36
            arroptions(2, 1) = Me.ddlteesize.SelectedValue
            arroptions(2, 2) = Me.ddlteesize.SelectedItem.Text
            arroptions(2, 3) = "04KMILEPKD"
            arroptions(2, 4) = 42
           

            SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty.Text, Me.LBLPKG.Text, "Milestone Package", CInt(Me.txtqty.Text), arroptions)
    ...
    Protected Sub CustomValidator2_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles CustomValidator2.ServerValidate
        ...
        If Trim(Me.ddlcapclr.SelectedItem.Text) = "Please Select" Then
            ...
            retval = False
        ElseIf Trim(Me.ddltasclr.SelectedItem.Text) = "Please Select" Then
            Me.CustomValidator2.ErrorMessage = "Please select a tassel color."
            retval = False
        ElseIf Trim(ddlteesize.SelectedItem.Text) = "Please Select" Then
            Me.CustomValidator2.ErrorMessage = "Please select a tee size."
            retval = False
