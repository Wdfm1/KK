...
Partial Class scholarpkgcart
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Page.IsValid Then
            ...
            If txtqty5.Text <> Nothing Then
                ...
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty.Text, Me.LBLPKG.Text, "Scholar Package", CInt(txtqty5.Text), arroptions)
            ...
            If txtqty4.Text <> Nothing Then
               ...
               Dim arroptions(5, 4) As String
                ...
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty.Text, Me.LBLPKG.Text, "Scholar Package", CInt(txtqty4.Text), arroptions)
            ...
            If txtqty3.Text <> Nothing Then
               ...
               Dim arroptions(5, 4) As String
                ...
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty.Text, Me.LBLPKG.Text, "Scholar Package", CInt(txtqty3.Text), arroptions)
            ...
            If txtqty2.Text <> Nothing Then
               ...
               Dim arroptions(5, 4) As String
                ...
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty.Text, Me.LBLPKG.Text, "Scholar Package", CInt(txtqty2.Text), arroptions)
            ...
            If txtqty1.Text <> Nothing Then
               ...
               Dim arroptions(5, 4) As String
                ...
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty.Text, Me.LBLPKG.Text, "Scholar Package", CInt(txtqty1.Text), arroptions)
            ...
            If txtqty0.Text <> Nothing Then
               ...
               Dim arroptions(5, 4) As String
                ...
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty.Text, Me.LBLPKG.Text, "Scholar Package", CInt(txtqty0.Text), arroptions)
    ...
    Protected Sub CustomValidator2_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles CustomValidator2.ServerValidate
        ...
        ElseIf Trim(ddlsash.SelectedItem.Text) = "Please Select" Then
            Me.CustomValidator2.ErrorMessage = "Please select a sash style."
            retval = False
        ElseIf Trim(ddlcert.SelectedItem.Text) = "Please Select" Then
            Me.CustomValidator2.ErrorMessage = "Please select a certificate."
            retval = False
		End If
