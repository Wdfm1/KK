            ...
            <ul>
              ...
              <li>Tee</li>
				...
				<div id="select_options">
                       ...
                       <a href="#" onclick="MM_swapImage('theImg5','','../images/capsandgowns/caps/006.jpg',1)">
                        ...
                        <img src="../images/capsandgowns/caps/white1.jpg" alt="" width="37" height="40" id="239" onclick="changevalue(this);" border="0" /></a>
                    				...
                    				<tr>
										...
										<td width="267"><asp:DropDownList  runat="server" Height="23px" Width="140px" onchange="change(this);" ID="ddlcapclr" DataSourceID="dscapclr" DataTextField="optiondesc" DataValueField="id"></asp:DropDownList>
                             				<script>
                                 				function change(x) {
                  ...
                  <img src="../images/tasselsandsashes/tassels/tassel_small_NEW/Tassel_rainbow_13_SM.jpg" alt="Tassel_rainbow_13_SM.jpg" width="25" height="60" id="180" onClick="changevalue2(this);" /></a>
