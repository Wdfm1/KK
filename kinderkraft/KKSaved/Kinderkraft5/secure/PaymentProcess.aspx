...
&nbsp;<div id="grdCharges" runat="server" style="width: 951px; overflow: auto;">
<div align="center"> 
	...
	<asp:SqlDataSource ID="dscustord" runat="server" 
        ...
        SelectCommand="SELECT cust.fname, cust.lname, cust.EmailAddress, cust.CompanyName, orders.orderid, orders.customerid, orders.orderdate, orders.total, orders.paytype, orders.orderstatus, orders.authdate, cust.custid, orders.autherr, payment.authcode AS authcode, payment.ccnum AS ccnum, payment.transid FROM cust INNER JOIN orders ON cust.custid = orders.customerid LEFT JOIN payment ON orders.orderid = payment.orderid ORDER BY orders.orderdate DESC"></asp:SqlDataSource>
