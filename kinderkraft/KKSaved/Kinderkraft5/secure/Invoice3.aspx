...
<table cellpadding="0" cellspacing="0" style="width: 672px">
			...
			<td align="left" valign="top" style="font-size: large">
				...
				<asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" 
					...
					<Fields>
						...
						<asp:BoundField DataField="scountry" HeaderText="scountry" 
    ...
    <span class="pkg_order_instr"> Your complete order details can be viewed by clicking the Next Page arrows at the bottom of the box.</span>
<asp:GridView ID="gv1" runat="server" Width="700px" 
			AutoGenerateColumns="False" CellPadding="10" ForeColor="#333333" 
			GridLines="None" HorizontalAlign="Center" BorderStyle="Ridge" 
			AllowPaging="True" PageSize="4" DataKeyNames="detailid,pkgid,OrderId" 
        Font-Size="7pt" >
  <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
		<Columns>
...
<asp:TemplateField HeaderText="Options">
    ...
    <div class="invoice"><table style="width:700px; height: 73px;">
		...
		<tr>
		  <td class="style43" align="right" >Shipping 
                Method:<asp:Label ID="lblmethod" runat="server"></asp:Label>
              <br />
              <asp:Label ID="Label5" runat="server" Text="Expedited delivery by:" 
                  Visible="False"></asp:Label>
              <asp:Label
                  ID="lblexpdate" runat="server" Text="Label" Visible="False"></asp:Label>
            </td>
