...
Partial Class OrderSearch
 ...
 Response.Redirect("../login.aspx")
    ...
    Protected Sub DetailsView2_ItemUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DetailsViewUpdateEventArgs) Handles DetailsView2.ItemUpdating
        ...
        Dim COMPname As String = e.NewValues.Item("scompanyname")
        Dim shipmethod As String = e.NewValues.Item("shipmethod")
        Dim COMPname1 As String = e.OldValues.Item("scompanyname")
        Dim izip As Integer
        Dim ddlshipmeth As DropDownList = DetailsView2.FindControl("ddlshipmeth")
        Dim cmd As String = "UPDATE orders SET scompanyname = @scompanyname, sfname = @sfname, slname = @slname, saddr = @saddr, sadd2 = @sadd2, scity = @scity, sstate = @sstate, szip = @szip, ponumber = @ponumber,shipmethod=@shipmethod, authnettranid = @authnettranid,authcode=@authcode,bo = @bo WHERE (orderid = @orderid)"
    ...
    Protected Sub Button1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
		Dim cmdstr As String = "SELECT cust.fname, cust.lname, cust.EmailAddress, cust.CompanyName, cust.billingaddr1, cust.billingaddr2, cust.city, cust.state," _
							 ...
							 & "orders.subtot, orders.shipmethod,orders.shpchrg, orders.tax, orders.total, orders.authnettranid, orders.bo, orders.orderstatus," _
							 ...
							 & "orders.paymentcompleted,payment.orderid AS porderid,payment.paydate, payment.amount, payment.paytype AS ppaytype, payment.transid," _
