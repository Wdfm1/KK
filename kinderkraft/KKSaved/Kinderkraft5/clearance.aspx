<%@ Page Language="VB" AutoEventWireup="false" CodeFile="clearance.aspx.vb" Inherits="clearance" %>
...
<div id="content">
    ...
    <table style="width: 685px; cellpadding="0" cellspacing="0" height: 540px;">
		...
		<a href="shopjostenshome.aspx">Home</a> &gt; <a href="clearance.aspx">Clearance</a><br />
		<br />
  
 <img alt="" height="117" src="images/clearance/clearance_heading.png" width="720" /><br /><br /></td></tr></table>
    
<div class="products_accessories"> Get these discontinued items at a discounted price.</div>
<div class="products"> <a href="cartpages/keepsakecart.aspx"><img src="images/home pg images/kk_mag_frame.jpg" alt="Magnetic Keepsake Frame" name="ProductPicture" width="210" height="210" id="ProductPicture" /></a>
    <div class="description">
      <h6>Magnetic Keepsake Frame</h6>
      <h2>Our Price: <asp:Label ID="KMF" runat="server" ForeColor="#D74141" Text="KMF"></asp:Label></h2>
      </div>
    </div></div>
