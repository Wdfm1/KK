...
Partial Class login
    ...
    Protected Sub Login1_Authenticate(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.AuthenticateEventArgs) Handles Login1.Authenticate
        ...
        selectcmd = "SELECT distinct  cust.iscs,cust.username,cust.EmailAddress,Companyname,password,postalcode,spostalcode,taxexemptconfirmed,state,holdpayment,allowpo,dollar11,dollar12,dollar13,custid from cust where trim(cust.username)='" & cUser & "' and trim(cust.password)='" & cPassword & "';"
