...
<div>
		...
		<tr>
			<td align="left" style="font-size: large">
				...
				<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
					...
					Height="91px" Width="346px" DataKeyNames="custid,emailaddress" Font-Size="Smaller">
	...
	<asp:GridView ID="gv1" runat="server" Height="16px" Width="700px" 
 ...
 <asp:FormView 
		...
		<tr>
			<td class="style38" align="right">
			    <asp:Label ID="Label9" runat="server" Text="Expedited Delivery Date:"></asp:Label>
                <asp:Label ID="Label10" runat="server" 
                    Text='<%# Eval("expdeliverdate", "{0:d}") %>' Font-Bold="True"></asp:Label>
			</td>
...
&nbsp;&nbsp;
		...
		<div align="left" style="font-size: medium; font-style: italic">
         ...
         weeks unless expedited shipping was selected. If you have any questions contact customer service at 855-826-2355.
