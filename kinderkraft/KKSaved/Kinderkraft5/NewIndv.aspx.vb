...
Partial Class NewIndv
    ...
    Protected Sub DSCust_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs) Handles DSCust.Inserted
        ...
        selectcmd = "SELECT distinct  cust.iscs,cust.username,cust.EmailAddress,state,companyname, password,postalcode,taxexempt,state,custid from cust where cust.username='" & Trim(username.Text) & "';"
    ...
    Protected Sub ddlState_DataBound(sender As Object, e As System.EventArgs)
        ...
        If Not IsNothing(ViewState("stateinsert")) Then
            ddlstate.SelectedValue = ViewState("stateinsert")
        End If
    End Sub
