...
<img alt="Kinderkraft 2013 Collection" height="50" src="images/kinderkraft.jpg" width="400" /><br />
  ...
  <div class="products"> <a href="cartpages/invitecart.aspx"><img src="images/home pg images/kk_invites_NEW.jpg" alt="Diplomas and Certificates" name="ProductPicture" width="210" height="210" id="ProductPicture7" /></a>
    <div class="description">
      <h6>Invitations</h6>
      <h2>Our Price: <asp:Label ID="KINV" runat="server" ForeColor="#D74141" Text="KINV"></asp:Label></h2>
      </div>
  </div>
  ...
  <div class="products"> <a href="cartpages/gradbearcart.aspx"><img src="images/home pg images/grad bear.jpg" alt="Huggable Grad Bears" name="ProductPicture" width="210" height="210" id="ProductPicture" /></a>
    <div class="description">
      <h6>Huggable Grad Bears</h6>
      <h2>Our Price: <asp:Label ID="BEA" runat="server" ForeColor="#D74141" Text="BEA"></asp:Label></h2><br /><br />
      </div>
  </div>
