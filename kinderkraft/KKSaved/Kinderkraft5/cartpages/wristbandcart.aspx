<%@ Page Title="" Language="VB"  AutoEventWireup="false" CodeFile="wristbandcart.aspx.vb" Inherits="wristbandcart" %>
...
<title>Graduate Wristband</title>
	...
	<table cellpadding="0" cellspacing="0" style="width: 660px; height: auto">
		<tr>
			<td class="style13" valign="top">
				<a href="../shopjostenshome.aspx">Home</a> &gt; <a href="../accessories.aspx">Accessories</a><br /><strong><span class="style15">Graduate Wristband<br /><br /></span></strong>
           	</td>
			<td></td>
		</tr>
		<tr>
			<td rowspan="2" valign="top">
			<img src="../images/accessories/wristband.jpg"  name="theImg" id="theImg3" onmouseover="MM_swapImgRestore()" />
			</td>
			<td height="79" valign="top">
				<div id="packprice" style="height:auto"> 
					<strong>Our Price:<font> <span class="red">$</span><asp:Label ID="KWRIST" runat="server" ForeColor="#D74141" Text="KWRIST"></asp:Label><br /><br /></font></strong>They can wear this durable rubber wristband every day that proudly states they&#39;re a “graduate.”
           		</div>
     		</td>
     	<tr>
