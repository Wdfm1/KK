<%@ Page Title="" Language="VB"  AutoEventWireup="false" CodeFile="createacapcart.aspx.vb" Inherits="createacapcart" %>
...
<table style="width: 700px; height: auto" cellpadding="0" cellspacing="0">
	<tr>
		<td class="style13" valign="top">
		<a href="../shopjostenshome.aspx">Home</a> &gt; <a href="../accessories.aspx">Accessories</a><br />
			<strong><span class="style15">Create-A-Cap<br />
			<br />
			</span></strong></td>
	...
	<tr>
		<td rowspan="2" valign="top" class="style25">
			...
			<img
				src="../images/accessories/createacap.jpg"  name="theImg" id="theImg3"  />
		</td>
		
        <td height="auto" valign="top" class="style18">
		<div id="packprice" style="height:auto"> 
			<strong>Our Price: <span class="red">$</span><asp:Label ID="KCCAP10PK" runat="server" 
				ForeColor="#D74141" Text="KCCAP10PK"></asp:Label> 
			   (Package of 10)</strong>
			   <br /><br />
			 	Teach children about the tradition and value of graduation with this art project—decorating and assembling a card stock Graduation Cap. Get kids excited about graduation when you order early. Have graduates decorate the caps, order them for other grades in your school to include them and extend the graduation experience. Adjustable size cap can be decorated with markers or crayons and includes a clip for a tassel. Sold in packs of 10
		</div></td>
            
          
			 <tr><td valign="top" style="height:auto"> <div id="select_options">
					  ...
					  <td class="style9" colspan="2">
						...
						&nbsp;&nbsp;&nbsp;
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                ErrorMessage="Enter quantity" ControlToValidate="txtqty" 
  ...
  <div class="req_field_val">              <asp:RegularExpressionValidator ID="numval" runat="server" 
