<%@ Page Title="" Language="VB"  AutoEventWireup="false" CodeFile="diplomacovercart.aspx.vb" Inherits="diplomacovercart" %>
...
<table style="width: 605px; height: 350px" cellpadding="0" cellspacing="0">
	<tr>
		...
		<a href="../shopjostenshome.aspx">Home</a> &gt; <a href="../diplomasandcertificates.aspx">Diplomas and Certificates</a><br />
			<strong><span class="style15">Diploma Cover<br /><br /></span></strong>
        </td>
    ...
    <tr>
		<td rowspan="2" valign="top"><img src="../images/diplomasandcertificates/KDIPC-1.jpg" name="theImg" id="theImg3" />
        </td>
		<td height="79" valign="top">
			<div id="packprice" style="height:auto" > 
			<strong>Our Price: <span class="red">$</span><asp:Label ID="KDIPC" runat="server" ForeColor="#D74141" Text="KDIPC"></asp:Label><br /><br /></strong>
			This special achievement is even more meaningful when presented inside a protective red cover.
            </div>
        </td>
	</tr>  
