<%@ Page Title="" Language="VB"  AutoEventWireup="false" CodeFile="yearcharmcart.aspx.vb" Inherits="yearcharmcart" %>
...
<table cellpadding="0" cellspacing="0" style="width: 660px; height: auto">
	<tr>
		<td class="style13" valign="top">
			<a href="../shopjostenshome.aspx">Home</a> &gt; <a href="../accessories.aspx">Accessories</a><br /><strong><span class="style15">2014 Charm<br /><br /></span></strong></td>
		<td></td>
	</tr>
	<tr>
		<td rowspan="2" valign="top">
        <img src="../images/accessories/yeardate2014_LG.png"  name="theImg" width="269" height="280" id="theImg3" onmouseover="MM_swapImgRestore()" />
		</td>
		
        <td height="79" valign="top">
			<div id="packprice" style="height:auto"> 
				<strong>Our Price:<font> <span class="red">$</span><asp:Label ID="TYD" 
                    runat="server" ForeColor="#D74141" Text="TYD"></asp:Label><br /><br /></font></strong>
            </div>
        </td>
