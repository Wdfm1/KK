			  ...
			  <table width="400">
                        ...
                        <a href="#" onclick="MM_swapImage('theImg','','../images/capsandgowns/caps/004.jpg',1)">
                    		...
                    		<tr valign="middle">
								...
								<td width="300">
                                	<asp:DropDownList  runat="server" Height="19px" Width="116px" onchange="change(this);" ID="ddlclr" DataSourceID="dscolor" DataTextField="optiondesc" DataValueField="id"></asp:DropDownList>
