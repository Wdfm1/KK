<%@ Page Title="" Language="VB"  AutoEventWireup="false" CodeFile="csashescart.aspx.vb" Inherits="csashescart" %>
...
<table style="width: 660px; height: auto" cellpadding="0" cellspacing="0">
	<tr>
        ...
        <strong><span class="style15">Choir Sash<br /><br /></span></strong>
        </td>
		<td></td>
	</tr>
    ...
    <tr>
		<td rowspan="2" valign="top" class="style25">
			<img src="../images/tasselsandsashes/sashes/kk_sashes_choir_2.jpg" name="theImg" id="theImg3" onmouseover="MM_swapImgRestore()" />
        </td>
		<td height="57">
			<div id="packprice" style="height:auto">  
				<strong>Our Price:<span class="red">$</span><asp:Label ID="KCHOIRSASH" runat="server" ForeColor="#D74141" Text="KSASH"></asp:Label><br /><br />
				</strong>
            </div>	
        </td>
    </tr>
				...
				<h3>Choose your options...</h3>
                	<table width="370">
                 		<tr>
               			...
               			<div class="req_field_val"> <asp:RegularExpressionValidator ID="numval2" runat="server" ControlToValidate="txtqty" ErrorMessage="Enter a numeric value" ForeColor="Red" ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                        </div>
</div>
		</td>
 	</tr>
