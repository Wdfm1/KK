				...
				<script>
						function change(x) {
				  		...
				  		<tr>
					  		...
					  		<td width="82"><asp:DropDownList  runat="server" Height="19px" Width="116px" onchange="javascript:change(this);" DataSourceID="dscolor" DataTextField="optiondesc" DataValueField="id" ID="ddlclr" CausesValidation="True"></asp:DropDownList>
					  		</td>
				  		</tr>
						...
						<tr>
							<td align="right">
        						<asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txtqty6" ErrorMessage="Enter a numeric value" ForeColor="Red" ValidationExpression="^\d+$"></asp:RegularExpressionValidator> <asp:TextBox ID="txtqty0" runat="server" Width="36px" CausesValidation="True"></asp:TextBox>
                           	</td>
							<td class="floatleft">
