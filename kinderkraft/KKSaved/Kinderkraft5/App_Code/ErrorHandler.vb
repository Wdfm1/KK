...
Namespace XC.Web
    Public Class ErrorHandler
        ...
        Public Sub HandleException(asessions As Array)
            ...
            If e IsNot Nothing Then
                HandleException(e, asessions)
            End If
        End Sub

        Public Sub HandleException(e As Exception, asessions As Array)
            Dim sExceptionDescription As String = FormatExceptionDescription(e, asessions)
        ...
        Protected Overridable Function FormatExceptionDescription(e As Exception, asessions As Array) As String
