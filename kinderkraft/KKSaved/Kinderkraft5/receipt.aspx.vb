...
Partial Class receipt
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '______Crawler test_________________________________________________________________________________________________________________
        ...
        '        Dim prevurl As String = Request.UrlReferrer.ToString
        ...
        '        objMM1.To.Add(tomail) 'customer address
        '        'Send the email in text format
        '        objMM1.IsBodyHtml = True

        '        'Set the subject
        '        objMM1.Subject = "Web Crawler Alert  (" & Now & ")"
        ...
        '    End Try
        'End If
        'End crawler test_____________________________________________________________________________________________________________________________________
		LoadLic()
        ...
        If Not IsPostBack Then
			...
			'Dim conn As New MySqlConnection(ConfigurationManager.ConnectionStrings("KK5").ToString)
			'Dim qstr As String = "select orderdate from orders where orderid=@orderid;"
			...
			'Dim diff As TimeSpan = Now.Date.Subtract(orderdate)


			'If diff.Days < 1 Then '60 days then cut off
			...
			ElseIf cs.ToUpper = "TRUE" Then
				EmailReceiptCS()
			End If
			'Else 'greater than 1 day  CS is doing this
			'	Try
			'		If cs.ToUpper = "TRUE" Then
			'			EmailReceiptCS()
			'		ElseIf cs.ToUpper = "FALSE" Then
			'			EmailReceipt()
			'		End If
			'	Catch ex As Exception
