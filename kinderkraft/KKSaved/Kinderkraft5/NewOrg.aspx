		...
		<EditItemTemplate>
             ...
             <div class="invoice">   
               ...
               <table width="700px">
                    ...
                    <tr align="left">
                        <td width="214" align="right" valign="baseline" class="field_label">
                            <asp:Label ID="Label13" runat="server" Text="*Enter a Username:"></asp:Label>
                        
                          
                      
                      </td>
                        <td width="474" align="left" valign="top" class="field_label"><asp:TextBox ID="txtusername1" runat="server" CausesValidation="True" 
                                Height="22px" 
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" class="field_label">
                            <asp:TextBox ID="txtzip" 
								runat="server" Height="22px" 
                                Text='<%# bind("postalcode") %>' Width="161px" TabIndex="12" MaxLength="5"></asp:TextBox><div class="req_field_val"><asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                    ...
                    <tr>
                      <td colspan="2" align="left" valign="baseline" class="pkg_order_instr">If you are a first-time tax exempt customer please upload your tax certificate using the browse button or submit it by fax(660-827-4252) or email (kinderkraft@jostens.com).<br />Once 
						  your tax certificate is verified, the tax charges will be credited. This process 
						  could take 3-4 weeks.</td>
                    </tr>
                    <tr>
               ...
               <table width="700px">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" class="field_label">
                            <asp:TextBox ID="txtzip" 
								runat="server" Height="22px" 
                                Text='<%# bind("postalcode") %>' Width="265px" TabIndex="11" MaxLength="5"></asp:TextBox><div class="req_field_val"><asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                                ControlToValidate="txtzip" Display="Dynamic" 
                                ErrorMessage="Zip Code Required"></asp:RequiredFieldValidator></div></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="right" valign="top" class="style9">
                           ...
                           <asp:Button ID="Button1" runat="server" CommandName="insert" 
                                 Text="Continue" TabIndex="15" onclick="Button1_Click"  /></td>
                    </tr>
               </table></div>
