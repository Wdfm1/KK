...
<span class="cont_guest">If you are having trouble logging in, please contact a customer service representative at 1-855-826-2355.</span></td>
      <td class="padding" valign="top"><asp:Button ID="Button1" runat="server" Height="23px" Text="School/Organization" Width="150px" />&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" Height="23px" Text="Individual/Parent" Width="150px" /><br />
       ...
       <tr>
      <td class="tax_info" colspan="2"><p><font color="#FF0000"><strong>Tax Exempt Information-</strong></font> If you are a tax exempt organization create an account as a School/Organization where you can upload your tax certificate online. Please note that the order can be placed online but tax will be charged. When the tax exempt certificate is verified, the tax will be refunded.</p></td>
      </tr>
    <tr>
