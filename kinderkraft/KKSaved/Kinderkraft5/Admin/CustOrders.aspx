<%@ Page Title="" Language="VB"  AutoEventWireup="false" CodeFile="CustOrders.aspx.vb" Inherits="CustOrders" %>
...
<div id="content" 
	...
	<asp:Label ID="Label25" runat="server" Font-Bold="True" Font-Size="Larger" 
        Font-Underline="True" Text="Customer Order Search"></asp:Label>
    <br />
	<br />
	<div>
	 Customer ID:<asp:TextBox ID="searchcustid" runat="server" 
            Width="154px"></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" 
            runat="server" Text="Search For Customer" Width="137px" />
	&nbsp;<asp:Button ID="Button3" runat="server" Text="Telephone Log" />
	</div>
	<br />
    <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="Blue" 
                            onclick="LinkButton2_Click">Edit Customer Info</asp:LinkButton>
	<br />
	
   
	<asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" 
        AutoGenerateRows="False" CellPadding="4" DataKeyNames="custid,companyname" 
	...
	<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
		...
		<Columns>
			<asp:HyperLinkField DataTextField="orderid" HeaderText="Order ID" 
                ...
                DataNavigateUrlFormatString="~/secure/OrderSearch.aspx?orderid={0}&amp;customerid={1}">
			...
			<asp:BoundField DataField="shipdate" HeaderText="Ship Date" 
                DataFormatString="{0:d}" />
		    <asp:BoundField DataField="ordernotes" HeaderText="Notes" />
	...
	<div align="center">
        ...
        <asp:Button ID="Button2" runat="server" 
            Text="Create A New Order For Current Customer" />
    </div>
  	</div>
	...
	<asp:SqlDataSource ID="dscust1" runat="server" 
		ConnectionString="<%$ ConnectionStrings:KK5 %>" 
		ProviderName="<%$ ConnectionStrings:KK5.ProviderName %>">
	</asp:SqlDataSource>
