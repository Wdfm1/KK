...
Partial Class CustOrders
	...
	Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        selectcmd = "SELECT distinct  cust.iscs,cust.username,cust.EmailAddress,Companyname,password,postalcode,spostalcode,taxexemptconfirmed,state,holdpayment,allowpo,dollar11,dollar12,dollar13,custid from cust where cust.custid=" & custid & ";"
