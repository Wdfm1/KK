<%@ Page Language="VB" AutoEventWireup="false" CodeFile="country.aspx.vb" Inherits="Admin_country" %>
...
&nbsp;
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        DataSourceID="dscountry" GridLines="Vertical" 
        Width="267px" ShowFooter="True" Height="316px" DataKeyNames="name">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Country Abrv" SortExpression="abrv">
                <FooterTemplate>
                ...
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("abbrev") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("abbrev") %>'></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="75px" />
            </asp:TemplateField>
        </Columns>
    ...
    <asp:SqlDataSource ID="dscountry" runat="server" 
        ...
        SelectCommand="SELECT name, abbrev FROM country ORDER BY name" 
