				...
				<tr>
					...
					<td>
						<asp:TextBox ID="TextBox8" runat="server" Height="21px" 
							Text='<%# bind("phonenumber") %>' Width="190px" MaxLength="15"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td align="right" class="style76">
		...
		<asp:ListItem>Returning Customer</asp:ListItem>
				...
				<tr>
					<td align="right" class="style76">
						Zip Code:</td>
					<td align="left" class="style75">
						<asp:TextBox ID="TextBox18" runat="server" Text='<%# bind("spostalcode") %>'></asp:TextBox>
					</td>
					<td align="right">
						Phone#</td>
					<td align="left" class="style33">
						<asp:TextBox ID="TextBox17" runat="server" Height="21px" 
							Text='<%# bind("sphonenumber") %>' Width="188px" MaxLength="15"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td align="right" class="style76">
				...
				<tr>
					...
					<td>
						<asp:TextBox ID="TextBox8" runat="server" Height="17px" 
							Text='<%# bind("phonenumber") %>' Width="140px" MaxLength="15"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td align="right" class="style87">
				...
				<tr>
					...
					<td align="left" class="style33">
						<asp:TextBox ID="TextBox17" runat="server" Height="16px" 
							Text='<%# bind("sphonenumber") %>' Width="184px" MaxLength="15"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td align="right" class="style87">
