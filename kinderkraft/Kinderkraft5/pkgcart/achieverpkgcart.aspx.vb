...
Partial Class achieverpkgcart
  ...
  lt.ConnectStr = ConfigurationManager.ConnectionStrings("KK5").ToString 
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Page.IsValid Then
            ...
            If txtqty6.Text <> Nothing Then
				...
				Dim arroptions(5, 4) As String
                arroptions(0, 1) = GetCapColorId(ddlclr.SelectedValue)
                arroptions(0, 2) = Trim(Me.ddlclr.SelectedItem.Text)
                arroptions(0, 3) = "03KACHPKD"
                arroptions(0, 4) = 45
                arroptions(1, 1) = Me.ddlclr.SelectedValue
                arroptions(1, 2) = Trim(Me.ddlclr.SelectedItem.Text)
                arroptions(1, 3) = "03KACHPKD"
                arroptions(1, 4) = 21
                arroptions(2, 1) = Me.ddlsize.SelectedValue
                arroptions(2, 2) = Trim(Me.ddlsize.SelectedItem.Text)
                arroptions(2, 3) = "03KACHPKD"
                arroptions(2, 4) = 34
                arroptions(3, 1) = Me.ddltasclr.SelectedValue
                arroptions(3, 2) = Me.ddltasclr.SelectedItem.Text
                arroptions(3, 3) = "03KACHPKD"
                arroptions(3, 4) = 36
                arroptions(4, 1) = Me.ddlcert.SelectedValue
                arroptions(4, 2) = Me.ddlcert.SelectedItem.Text
                arroptions(4, 3) = "03KACHPKD"
                arroptions(4, 4) = 39
				arroptions(5, 1) = 213
				arroptions(5, 2) = "Graduate"
				arroptions(5, 3) = "03KACHPKD"
				arroptions(5, 4) = 43
               

                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty6.Text, Me.LBLPK.Text, "Achiever Package", CInt(txtqty6.Text), arroptions)
            ...
            If txtqty5.Text <> Nothing Then
				...
				arroptions(2, 2) = Trim(Me.ddlsize0.SelectedItem.Text)
				arroptions(2, 3) = "03KACHPKD"
				arroptions(2, 4) = 34
				arroptions(3, 1) = Me.ddltasclr.SelectedValue
				arroptions(3, 2) = Me.ddltasclr.SelectedItem.Text
				...
				arroptions(5, 3) = "03KACHPKD"
				arroptions(5, 4) = 43
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty6.Text, Me.LBLPK.Text, "Achiever Package", CInt(txtqty5.Text), arroptions)
                Session("ShoppingCart") = SC
            End If
            If txtqty4.Text <> Nothing Then
				...
				arroptions(2, 2) = Trim(Me.ddlsize1.SelectedItem.Text)
				arroptions(2, 3) = "03KACHPKD"
				arroptions(2, 4) = 34
				arroptions(3, 1) = Me.ddltasclr.SelectedValue
				arroptions(3, 2) = Me.ddltasclr.SelectedItem.Text
				...
				arroptions(5, 3) = "03KACHPKD"
				arroptions(5, 4) = 43
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty6.Text, Me.LBLPK.Text, "Achiever Package", CInt(txtqty4.Text), arroptions)
                Session("ShoppingCart") = SC
            End If
            If txtqty3.Text <> Nothing Then
				...
				arroptions(2, 2) = Trim(Me.ddlsize2.SelectedItem.Text)
				arroptions(2, 3) = "03KACHPKD"
				arroptions(2, 4) = 34
				arroptions(3, 1) = Me.ddltasclr.SelectedValue
				arroptions(3, 2) = Me.ddltasclr.SelectedItem.Text
				...
				arroptions(5, 3) = "03KACHPKD"
				arroptions(5, 4) = 43
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty6.Text, Me.LBLPK.Text, "Achiever Package", CInt(txtqty3.Text), arroptions)
                Session("ShoppingCart") = SC
            End If
            If txtqty2.Text <> Nothing Then
				...
				arroptions(2, 2) = Trim(Me.ddlsize3.SelectedItem.Text)
				arroptions(2, 3) = "03KACHPKD"
				arroptions(2, 4) = 34
				arroptions(3, 1) = Me.ddltasclr.SelectedValue
				arroptions(3, 2) = Me.ddltasclr.SelectedItem.Text
				...
				arroptions(5, 3) = "03KACHPKD"
				arroptions(5, 4) = 43
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty6.Text, Me.LBLPK.Text, "Achiever Package", CInt(txtqty2.Text), arroptions)
                Session("ShoppingCart") = SC
            End If
            If txtqty1.Text <> Nothing Then
				...
				arroptions(2, 2) = Trim(Me.ddlsize4.SelectedItem.Text)
				arroptions(2, 3) = "03KACHPKD"
				arroptions(2, 4) = 34
				arroptions(3, 1) = Me.ddltasclr.SelectedValue
				arroptions(3, 2) = Me.ddltasclr.SelectedItem.Text
				...
				arroptions(5, 3) = "03KACHPKD"
				arroptions(5, 4) = 43
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty6.Text, Me.LBLPK.Text, "Achiever Package", CInt(txtqty1.Text), arroptions)
                Session("ShoppingCart") = SC
            End If
            If txtqty0.Text <> Nothing Then
				...
				arroptions(2, 2) = Trim(Me.ddlsize5.SelectedItem.Text)
				arroptions(2, 3) = "03KACHPKD"
				arroptions(2, 4) = 34
				arroptions(3, 1) = Me.ddltasclr.SelectedValue
				arroptions(3, 2) = Me.ddltasclr.SelectedItem.Text
				...
				arroptions(5, 3) = "03KACHPKD"
				arroptions(5, 4) = 43
                SC.AddPkgToCart(SC.orderdetail, lt, Me.lblprodcode.Text, Me.txtqty.Text, Me.LBLPK.Text, "Achiever Package", CInt(txtqty0.Text), arroptions)
                Session("ShoppingCart") = SC
            End If
    ...
    Protected Sub LBLPKG_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles LBLPK.Load
        If Not IsPostBack Then
            Dim prodcode As Label = sender
            Me.LBLPK.Text = Me.RetPrice(sender.text.ToString.ToUpper)
        End If
    End Sub
    ...
    Protected Sub CustomValidator4_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles CustomValidator4.ServerValidate
        ...
        If Trim(Me.ddlclr.SelectedItem.Text) = "Please Select" Then
            Me.CustomValidator4.ErrorMessage = "Please select a gown/cap color."
            retval = False
        ElseIf Trim(Me.ddlsize.SelectedItem.Text) = "Please Select" Then
            Me.CustomValidator4.ErrorMessage = "Please select a gown size."
            retval = False
        ElseIf Trim(ddltasclr.SelectedItem.Text) = "Please Select" Then
            Me.CustomValidator4.ErrorMessage = "Please select a tassel color."
            retval = False

        ElseIf Trim(ddlcert.SelectedItem.Text) = "Please Select" Then
            Me.CustomValidator4.ErrorMessage = "Please select a certificate."
            retval = False
		End If
    ...
    '    If txtqty6.Text <> "" And Not IsNumeric(txtqty6.Text) Then
    '        Me.CustomValidator3.ErrorMessage = "Qty must be numeric"
    '        retval = False
    '    Else
    '        If Trim(Me.ddlsize.SelectedItem.Text) = "Please Select" And txtqty6.Text <> "" Then
    '            Me.CustomValidator3.ErrorMessage = "Please select a size."
    '            retval = False
    '        End If
    '    End If

    '    If txtqty5.Text <> "" And Not IsNumeric(txtqty5.Text) Then
    '        Me.CustomValidator3.ErrorMessage = "Qty must be numeric"
    '        retval = False
    '    Else
    '        If Trim(Me.ddlsize0.SelectedItem.Text) = "Please Select" And txtqty5.Text <> "" Then
    '            Me.CustomValidator3.ErrorMessage = "Please select a size."
    '            retval = False
    '        End If
    '    End If

    '    If Me.txtqty4.Text <> "" And Not IsNumeric(txtqty4.Text) Then
    '        Me.CustomValidator3.ErrorMessage = "Qty must be numeric"
    '        retval = False
    '    Else
    '        If Trim(Me.ddlsize1.SelectedItem.Text) = "Please Select" And txtqty4.Text <> "" Then
    '            Me.CustomValidator3.ErrorMessage = "Please select a size."
    '            retval = False
    '        End If
    '    End If
    '    If txtqty3.Text <> "" And Not IsNumeric(txtqty3.Text) Then
    '        Me.CustomValidator3.ErrorMessage = "Qty must be numeric"
    '        retval = False
    '        If Trim(Me.ddlsize2.SelectedItem.Text) = "Please Select" And txtqty3.Text <> "" Then
    '            Me.CustomValidator3.ErrorMessage = "Please select a size."
    '            retval = False
    '        End If
    '    End If

    '    If txtqty2.Text <> "" And Not IsNumeric(txtqty2.Text) Then
    '        Me.CustomValidator3.ErrorMessage = "Qty must be numeric"
    '        retval = False
    '        If Trim(Me.ddlsize3.SelectedItem.Text) = "Please Select" And txtqty2.Text <> "" Then
    '            Me.CustomValidator3.ErrorMessage = "Please select a size."
    '            retval = False
    '        End If
    '    End If
    '    If txtqty1.Text <> "" And Not IsNumeric(txtqty1.Text) Then
    '        Me.CustomValidator3.ErrorMessage = "Qty must be numeric"
    '        retval = False
    '        If Trim(Me.ddlsize4.SelectedItem.Text) = "Please Select" And txtqty1.Text <> "" Then
    '            Me.CustomValidator3.ErrorMessage = "Please select a size."
    '            retval = False
    '        End If
    '    End If
    '    If txtqty0.Text <> "" And Not IsNumeric(txtqty0.Text) Then
    '        Me.CustomValidator3.ErrorMessage = "Qty must be numeric"
    '        retval = False
    '        If Trim(Me.ddlsize5.SelectedItem.Text) = "Please Select" And txtqty0.Text <> "" Then
    '            Me.CustomValidator3.ErrorMessage = "Please select a size."
    '            retval = False
    '        End If
    '    End If
