	...
	<tr>
		<td  align="right">
        	<asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                    ...
                    ValidationExpression="^\d+$"></asp:RegularExpressionValidator> <asp:TextBox ID="txtqty0" runat="server" Width="36px" CausesValidation="True" AutoPostBack="True"></asp:TextBox></td>
		<td class="floatleft">
