										...
										<tr>
											<td align="right" valign="top">
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                                                    ...
                                                    ForeColor="Red" ValidationExpression="^\d+$" Display="Dynamic"></asp:RegularExpressionValidator> <asp:TextBox ID="txtqty0" runat="server" Width="36px" CausesValidation="True" AutoPostBack="True"></asp:TextBox>
                                            </td>
